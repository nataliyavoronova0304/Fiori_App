...
(2) As a prerequisite you will have to create a server runtime environment called "Java Web".
You can do so through the menu: Window->Preferences->Server->Runtime Environment->Add...->SAP->Java Web...
If you imported a sample not having done the above you will have an error: "Faceted Project Problem: Target runtime Java Web is not defined".
